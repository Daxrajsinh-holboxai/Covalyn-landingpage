...
const Modal = () => {
  ...
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    onClick={toggleModal}
    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full text-sm font-semibold transition-colors shadow-md hover:shadow-lg"
  >
    Get Started
  </motion.button>
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    onClick={() => {
      console.log('Learn More clicked'); // Add navigation or modal logic here
    }}
    className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-full text-sm font-semibold transition-colors shadow-md hover:shadow-lg"
  >
    Learn More
  </motion.button>
</div>
