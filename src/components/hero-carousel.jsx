...
export default function HeroCarousel() {
  ...
  <AnimatePresence initial={false} custom={direction}>
    ...
    >
      <div className="relative rounded-2xl overflow-hidden bg-gray-200 shadow-lg order-1 lg:order-2 h-[250px] lg:h-full">
        <motion.img
  ...
  <div className="absolute left-0 right-0 bottom-4 flex justify-between items-center px-4">
    ...
    <div className="flex items-center space-x-2 z-10">
      <button
        ...
        className="w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center z-20 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
